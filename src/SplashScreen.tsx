							...
							<div id="item1" className="carousel-item w-full p-10">
								...
								>
									<form className="flex felx-row justify-between items-center ">
										...
										<a onClick={() => {setSlideSplashScreen(true)}} href="#item2" className="hover:border-blue-400 border-transparent btn bg-zinc-700 outline-none  text-white btn-sm w-[80px] h-[50px]">
											Create
										</a>
											{/* <button
												type="button"
									...
									<form className="flex  justify-between items-center space-x-6 max-w-1">
										...
										<div className="float-right">
										<a onClick={openFolder} className=" hover:border-blue-400 border-transparent btn bg-zinc-700 outline-none  text-white btn-sm w-[80px] h-[50px]">
										Open
										</a>
											{/* <button
												type="button"
								...
								<div
								>
									<a href="#item1" onClick={() => setSlideSplashScreen(false)} className=" absolute left-6 top-[-20px] text-2xl  btn bg-transparent hover:text-black hover:bg-transparent outline-none border-none float-left text-white btn-sm h-[50px]">
											<VscArrowSmallLeft/>
										</a>
									{/* <a
										href="#item1"
									...
									<form className="flex felx-row justify-between items-center space-x-6">
										...
										<div className="float-right">
										<a onClick={openFolder} className="btn bg-zinc-700 hover:border-blue-400 border-transparent outline-none text-white btn-sm h-[50px] w-[80px]">
										Open
										</a>
											{/* <button
												type="button"
							...
							{selectedFolder === ""  && !slideSplashScreen? (
								...
								<div className="tooltip" data-tip="Missing information">							
									<button
										...
										onClick={
											slideSplashScreen ? createMainFolder : setMainFolder
										}
									>
										Accept
									</button>
